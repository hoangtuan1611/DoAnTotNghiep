        ...
        <div className="h-auto bg-gradient-to-br from-blue-50 to-indigo-50 p-6">
          ...
          <div>
            <table className="w-full border-collapse border border-gray-300 mt-4">
              ...
              <thead>
                <tr className="bg-gray-100 w-1.5">
                  <th className="border border-gray-300 h-12">Thời gian</th>
                  <th className="border border-gray-300 p-2 h-12">Sáng</th>
                  <th className="border border-gray-300 p-2 h-12">Chiều</th>
                  <th className="border border-gray-300 p-2 h-12">Tối</th>
                </tr>
              </thead>
              <tbody>
                {days.map((day, index) => {
