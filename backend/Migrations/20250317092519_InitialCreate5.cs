        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImgPath = table.Column<string>(type: "varchar(500)", unicode: false, maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceLogs_Schedules_ScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceLogs_ScheduleId",
